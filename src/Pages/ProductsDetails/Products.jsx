  ...
  return (
    <div className="lg:w-[90%] w-[95%] mx-auto my-10 ">
      <div className="grid grid-cols-10">
        <div className="col-span-2">Sort By Diffrents catagories</div>
        <div className="col-span-8">
          <div className="mb-5 relative">
            <input
              className="w-full border-gray-300 py-3 rounded-md"
              type="text"
              placeholder="Search Here ..."
            />
            <IoSearch className="absolute right-3 sm:top-[25%] top-[20%] text-2xl" />
          </div>
                ...
                >
                  ...
                  <div className="mt-2">
                    ...
                    <div className="flex justify-between mt-2">
                      <button className="px-6 py-[3px] rounded-br-[20px] border-primary border-2 text-primary text-sm">
                        Order Now
                      </button>
